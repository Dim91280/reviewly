    ...
    <section id="pricing" className="py-20 px-6 bg-white">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-3 tracking-tight">Simple, honest pricing</h2>
          <p className="text-gray-400 text-sm">No contract. Cancel anytime.</p>
        </div>
        <div className="flex flex-col md:flex-row gap-5">

          <div className="flex-1 rounded-2xl p-7 border" style={{ borderColor: '#e5e7eb' }}>
            <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-4">Solo</p>
            <div className="flex items-baseline gap-1 mb-1">
              <span className="text-4xl font-bold text-gray-900">€19</span>
              <span className="text-gray-400 text-sm">/month</span>
            </div>
            <p className="text-gray-400 text-xs mb-7">Perfect to get started</p>
            ...
            <button onClick={() => handleCheckout(PRICE_SOLO, 'solo')} disabled={loading === 'solo'}
              className="w-full border font-medium py-2.5 rounded-xl text-sm disabled:opacity-50"
          ...
          <div className="flex-1 rounded-2xl p-7 relative" style={{ backgroundColor: '#0f172a' }}>
            <span className="absolute top-5 right-5 text-xs font-semibold px-2.5 py-1 rounded-lg"
              style={{ backgroundColor: '#6366f1', color: 'white' }}>POPULAR</span>
            <p className="text-xs font-medium uppercase tracking-wider mb-4" style={{ color: '#64748b' }}>Pro</p>
            <div className="flex items-baseline gap-1 mb-1">
              <span className="text-4xl font-bold text-white">€29</span>
              <span className="text-sm" style={{ color: '#64748b' }}>/month</span>
            </div>
            <p className="text-xs mb-7" style={{ color: '#64748b' }}>For growing businesses</p>
            <ul className="space-y-2.5 mb-8">
            ...
            <button onClick={() => handleCheckout(PRICE_PRO, 'pro')} disabled={loading === 'pro'}
              className="w-full text-white font-medium py-2.5 rounded-xl text-sm disabled:opacity-50"
