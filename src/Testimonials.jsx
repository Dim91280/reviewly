...
function Testimonials() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {testimonials.map((t, i) => (
          <div
            ...
            onMouseEnter={e => {
              e.currentTarget.style.borderColor = t.featured
          ...
          >
            ...
            <p style={{
              ...
              <span style={{
                fontSize: '22px', color: t.featured ? '#818CF8' : '#334155',
                lineHeight: 0, verticalAlign: '-7px', marginRight: '2px',
                fontStyle: 'normal',
              }}>"</span>
              {t.text}
            </p>
      ...
      <div style={{
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        gap: '48px', marginTop: '64px', flexWrap: 'wrap',
        ...fade(0.4),
      }}>
        {[
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '48px' }}>
            {i > 0 && <div style={{ width: '1px', height: '40px', background: 'rgba(255,255,255,0.07)' }} />}
            <div style={{ textAlign: 'center' }}>
              <div style={{
                fontSize: '30px', fontWeight: '800', letterSpacing: '-1.5px',
                background: 'linear-gradient(135deg, #818CF8, #22D3EE)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
              }}>{num}</div>
              <div style={{ fontSize: '12px', color: '#475569', fontWeight: '500', marginTop: '4px' }}>{label}</div>
            </div>
          </div>
        ))}
      </div>
