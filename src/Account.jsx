...
const TONES = [
  {
    id: 'professional',
    label: 'Professional',
    description: 'Formal, polished and business-oriented',
    icon: '👔',
  },
  {
    id: 'friendly',
  ...
  },
  {
    id: 'enthusiastic',
    label: 'Enthusiastic',
    description: 'Energetic, positive and expressive',
    icon: '🚀',
  },
  {
    id: 'empathetic',
    label: 'Empathetic',
    description: 'Caring, understanding and human',
    icon: '🤝',
  },
  {
    id: 'concise',
  ...
  },
  {
    id: 'luxury',
    label: 'Luxury',
    description: 'Elegant, refined and premium',
    icon: '✨',
  },
]
...
function Account() {
  ...
  const saveBusinessProfile = async () => {
    ...
    if (!error) {
      setToneSaved(true)
      setTimeout(() => setToneSaved(false), 2500)
    }
  }
      ...
      <div className="max-w-xl space-y-4">
        ...
        <div className="bg-white rounded-2xl border p-6" style={{ borderColor: '#f1f5f9' }}>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {TONES.map(t => (
                <button
                  ...
                  style={{
                    borderColor: tone === t.id ? '#6366f1' : '#f1f5f9',
                    backgroundColor: tone === t.id ? '#eef2ff' : '#f8fafc',
                    boxShadow: tone === t.id ? '0 0 0 1px #6366f1' : 'none',
                  }}
          ...
          >
            {savingTone ? (
              <>
                <svg className="animate-spin" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><circle cx="12" cy="12" r="10" strokeOpacity="0.3"/><path d="M12 2a10 10 0 0 1 10 10"/></svg>
                Saving...
              </>
            ) : toneSaved ? (
              <>
